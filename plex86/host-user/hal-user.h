...
extern void     halNetReadPacketToGuest(unsigned deviceNo);

extern volatile unsigned halNetConsumerCount; // Fixme:
extern volatile unsigned halNetProducerCount; // Fixme:
extern int fdTunTap;
